const CACHE='raysmart-v1.0-20260729';
const ASSETS=['./','./index.html','./search.html','./sn.html','./calendar.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./material.xlsx','./Calendar.xlsx'];
